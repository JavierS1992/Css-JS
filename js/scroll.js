(function(){
	...
	var propScroll = {
		...
		scroll_suaves : document.getElementsByClassName('scroll-suave'),
	...
	var metScroll = {
		inicio : function(){
			for (var i = 0; i < propScroll.scroll_suaves.length; i++) {
				propScroll.scroll_suaves[i].addEventListener('click',  metScroll.moverse);
			};
		...
		moverse : function(e){
			...
			propScroll.intervalo = setInterval( function(argument) {
